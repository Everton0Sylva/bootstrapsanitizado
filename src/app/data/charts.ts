...
export const lineChartDataHr = {
  labels: ['1a hour', '2a hour', '3a hour', '4a hour', '5a hour', '6a hour', '7a hour', '8a hour'],
  datasets: [
    {
      label: '',
      data: [54, 63, 60, 65, 60, 68, 60, 70],
